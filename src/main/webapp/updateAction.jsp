...
<body>
    <%
        ...
        if(!userID.equals(bbss.getUserID())) { //실제로 이 글을 작성한 사람이 맞는 지 확인함.
            ...
            if (request.getParameter("bbssTitle") == null || request.getParameter("bbssContent") == null
                    || request.getParameter("bbssTitle").equals("") || request.getParameter("bbssContent").equals("")) {
                PrintWriter script = response.getWriter();
                script.println("<script>");
                ...
                int result = bbssDAO.update(bbssID, request.getParameter("bbssTitle"), request.getParameter("bbssContent"));
